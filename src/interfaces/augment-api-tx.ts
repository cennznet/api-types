...
import { AccountId, AssetId, Balance, BalanceOf, BlockNumber, Call, ChangesTrieConfiguration, H256, Hash, Header, KeyValue, LookupSource, Moment, Perbill } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    elections: {
       ...
       * # </weight>
       **/
      removeMember: AugmentedSubmittable<(who: LookupSource | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * # </weight>
       **/
      reportDefunctVoter: AugmentedSubmittable<(target: LookupSource | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    treasury: {
       ...
       * # </weight>
       **/
      proposeSpend: AugmentedSubmittable<(value: Compact<BalanceOf> | AnyNumber | Uint8Array, beneficiary: LookupSource | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
