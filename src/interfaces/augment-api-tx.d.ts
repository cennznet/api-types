...
declare module '@polkadot/api/types/submittable' {
    interface AugmentedSubmittables<ApiType> {
        ...
        babe: {
             ...
             **/
            planConfigChange: AugmentedSubmittable<(config: NextConfigDescriptor | {
                V0: any;
            } | {
                V1: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [NextConfigDescriptor]>;
            /**
        ...
        genericAsset: {
            ...
            create: AugmentedSubmittable<(owner: AccountId | string | Uint8Array, options: AssetOptions | {
                initialIssuance?: any;
                permissions?: any;
            } | string | Uint8Array, info: AssetInfo | null) => SubmittableExtrinsic<ApiType>, [AccountId, AssetOptions, AssetInfo]>;
            /**
            ...
            createReserved: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, options: AssetOptions | {
                initialIssuance?: any;
                permissions?: any;
            } | string | Uint8Array, info: AssetInfo | null) => SubmittableExtrinsic<ApiType>, [AssetId, AssetOptions, AssetInfo]>;
            /**
            ...
            updatePermission: AugmentedSubmittable<(assetId: Compact<AssetId> | AnyNumber | Uint8Array, newPermission: PermissionLatest | {
                ...
                mint?: any;
                burn?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<AssetId>, PermissionLatest]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        identity: {
             ...
             * sub identity of `sub`.
             **/
            addSub: AugmentedSubmittable<(sub: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                ShaThree256: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [LookupSource, Data]>;
            /**
             ...
             * # </weight>
             **/
            killIdentity: AugmentedSubmittable<(target: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
             ...
             * # </weight>
             **/
            provideJudgement: AugmentedSubmittable<(regIndex: Compact<RegistrarIndex> | AnyNumber | Uint8Array, target: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array, judgement: IdentityJudgement | {
                Unknown: any;
            } | {
                FeePaid: any;
            } | {
                ...
                Erroneous: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<RegistrarIndex>, LookupSource, IdentityJudgement]>;
            /**
             ...
             * sub identity of `sub`.
             **/
            removeSub: AugmentedSubmittable<(sub: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
             ...
             * sub identity of `sub`.
             **/
            renameSub: AugmentedSubmittable<(sub: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
             ...
             * # </weight>
             **/
            setIdentity: AugmentedSubmittable<(info: IdentityInfo | {
                additional?: any;
                display?: any;
                legal?: any;
                web?: any;
                ...
                image?: any;
                twitter?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [IdentityInfo]>;
            /**
             ...
             * # </weight>
             **/
            setSubs: AugmentedSubmittable<(subs: Vec<ITuple<[AccountId, Data]>> | ([AccountId | string | Uint8Array, Data | {
                None: any;
            } | {
                Raw: any;
            } | {
                ...
                ShaThree256: any;
            } | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[AccountId, Data]>>]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        multisig: {
             ...
             * # </weight>
             **/
            asMultiThreshold1: AugmentedSubmittable<(otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], call: Call | {
                callIndex?: any;
                args?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<AccountId>, Call]>;
            /**
            ...
            cancelAsMulti: AugmentedSubmittable<(threshold: u16 | AnyNumber | Uint8Array, otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], timepoint: Timepoint | {
                height?: any;
                index?: any;
            } | string | Uint8Array, callHash: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, Vec<AccountId>, Timepoint, U8aFixed]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        nft: {
             ...
             **/
            mintSeries: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, quantity: TokenCount | AnyNumber | Uint8Array, owner: Option<AccountId> | null | object | string | Uint8Array, attributes: Vec<NFTAttributeValue> | (NFTAttributeValue | {
                i32: any;
            } | {
                u8: any;
            } | {
                ...
                Url: any;
            } | string | Uint8Array)[], metadataPath: Option<Bytes> | null | object | string | Uint8Array, royaltiesSchedule: Option<RoyaltiesSchedule> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, TokenCount, Option<AccountId>, Vec<NFTAttributeValue>, Option<Bytes>, Option<RoyaltiesSchedule>]>;
            /**
             ...
             * Caller must be the collection owner
             **/
            mintUnique: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, owner: Option<AccountId> | null | object | string | Uint8Array, attributes: Vec<NFTAttributeValue> | (NFTAttributeValue | {
                i32: any;
            } | {
                u8: any;
            } | {
                ...
                Url: any;
            } | string | Uint8Array)[], metadataPath: Option<Bytes> | null | object | string | Uint8Array, royaltiesSchedule: Option<RoyaltiesSchedule> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, Option<AccountId>, Vec<NFTAttributeValue>, Option<Bytes>, Option<RoyaltiesSchedule>]>;
            /**
        ...
        staking: {
             ...
             * # </weight>
             **/
            bond: AugmentedSubmittable<(controller: AccountId | string | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array, payee: RewardDestination | {
                Stash: any;
            } | {
                Controller: any;
            } | {
                Account: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, Compact<BalanceOf>, RewardDestination]>;
            /**
        ...
        treasury: {
             ...
             * # </weight>
             **/
            proposeSpend: AugmentedSubmittable<(value: Compact<BalanceOf> | AnyNumber | Uint8Array, beneficiary: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>, LookupSource]>;
            /**
