...
export default class ExtrinsicSignatureV0 extends Struct implements IExtrinsicSignature {
    constructor(registry: Registry, value: ExtrinsicSignatureV0 | Uint8Array | undefined, extSigOpt?: ExtrinsicSignatureOptions);
     ...
     */
    get doughnut(): import("@polkadot/types/types").Codec | undefined;
    /**
